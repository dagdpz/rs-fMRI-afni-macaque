...
# running 
set scr_swarm     = ${dir_swarm}/swarm_20_ap_voxTB.tcsh  # cmds to run, 1 per line
set scr           = ${DIR_SCR}/do_20_ap_voxTB.tcsh       # processing scr to use
...
foreach subj ( ${all_subj} ) 
    ...
    foreach ses ( ${all_ses} )
        ...
        set log = ${dir_log}/log_20_ap_voxTB_${subj}_${ses}.txt
