...
# running 
set scr_swarm     = ${dir_swarm}/swarm_22_ap_roiTB.tcsh  # cmds to run, 1 per line
set scr           = ${DIR_SCR}/do_22_ap_roiTB.tcsh       # processing scr to use
...
foreach subj ( ${all_subj} ) 
    ...
    foreach ses ( ${all_ses} )
        ...
        set log = ${dir_log}/log_22_ap_roiTB_${subj}_${ses}.txt
