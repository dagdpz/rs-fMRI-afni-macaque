...
set subname       = sub-Linus20230704
set dir_basic     = ${PWD:h}/data_basic
...
foreach ses ( ${all_ses} )
	...
	foreach func ( ${all_func} )
		 ...
		 set out_func = `basename "${func}"` #${subname}_ses-postdrug_run-0${i}_bold_ro.nii.gz
...
set temp_anat = 0101_t1w_LIP.nii.gz
...
foreach ses ( ${all_ses} )
	...
	set out_anat = `basename "${all_anat}"` #${subname}_ses-postdrug_desc-mac1003rec0101_T1w_ro.nii.gz
